...
def Connect2Web(url, patterns, order, postData, endPattern):
...
def insert(urlCode_url, patterns):
	...
	for link in listOfUrls:
		...
		data = Connect2Web(link, patterns, order, postData, endPattern)
		vals = []
